                                ...
                                <div class="p-4 mt-2">
                                    <table class="table table-bordered  border-dark text-dark">
                                      ...
                                      <tbody>
                                        ...
                                        $query = mysqli_query($connect, "SELECT j.id_jadwal, mk, jurusan, 
                                                  lab.id_lab, lab.lab AS lab, 
                                                  waktu.id_waktu AS id_waktu, waktu.waktu_mulai AS waktu_mulai, waktu.waktu_selesai AS waktu_selesai
                                                  FROM jadwal as j 
                                                  INNER JOIN lab ON j.id_lab = lab.id_lab
                                                  INNER JOIN waktu ON j.id_waktu = waktu.id_waktu");
                                        ...
                                        while ($data = mysqli_fetch_array($query)) { ?>
                                          <tr>
                                            ...
                                            <td><a class="ms-2 btn btn-sm btn-outline-light" href="ubah_jadwal.php?id_jadwal=<?= $data['id_jadwal'] ?>">Edit</td>
                                            <td><a class="btn btn-sm btn-outline-danger" href="hapus_jadwal.php?id_jadwal=<?= $data['id_jadwal'] ?>">Delete</td>
                                          </tr>
                                            <?php $nomor++; 
                                        } ?>
                                      </tbody>
